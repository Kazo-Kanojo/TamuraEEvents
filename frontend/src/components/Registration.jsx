  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-[#D80000] selection:text-white pb-40">
      ...
      <div className="max-w-5xl mx-auto p-6 pt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end border-b border-gray-800 pb-6 mb-10 gap-4">
          <div>
            <h1 className="text-4xl font-black italic uppercase tracking-tighter text-white">
              Inscrição <span className="text-[#D80000]">Confirmada</span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {plans.map((plan) => (
              <button 
                ...
                className={`
                  ...
                  ${selectedPlan?.id === plan.id 
                    ? 'border-[#D80000] bg-[#D80000]/10 shadow-[0_0_20px_rgba(216,0,0,0.2)]' 
              ...
              >
                ...
                <div className="text-3xl font-black text-[#D80000] mt-2 mb-2">
                  <span className="text-sm font-medium text-gray-500 mr-1">R$</span>{plan.price},00
                </div>
        ...
        {/* SEÇÃO 2: ESCOLHA AS CATEGORIAS */}
        {selectedPlan && (
          <section className="mb-8 animate-fade-in-up">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-gray-200 flex items-center gap-2">
                <span className="bg-[#D80000] w-6 h-6 rounded text-xs flex items-center justify-center text-black font-bold">2</span>
              ...
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      px-4 py-3 rounded-lg border text-sm font-medium text-left transition-all flex justify-between items-center
                      ${isSelected 
      ...
      <div className="fixed bottom-0 left-0 w-full bg-[#0f0f0f] border-t border-gray-800 p-4 z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex flex-col">
            <span className="text-gray-500 text-xs uppercase font-bold tracking-wider">Total a Pagar</span>
            <div className="text-3xl font-black text-white flex items-baseline gap-1">
              <span className="text-sm font-medium text-[#D80000]">R$</span>
          ...
          <button 
            ...
            disabled={loading || !selectedPlan || selectedCategories.length === 0}
            className={`
              flex items-center gap-3 px-6 md:px-10 py-3 md:py-4 rounded font-black uppercase tracking-widest transition-all text-sm md:text-base
              ${(!selectedPlan || selectedCategories.length === 0) 
                ? 'bg-gray-800 text-gray-600 cursor-not-allowed' 
                : 'bg-[#D80000] hover:bg-red-700 text-white shadow-lg hover:shadow-red-900/20 hover:-translate-y-1'}
            `}
          >
